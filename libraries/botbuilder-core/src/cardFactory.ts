 ...
 */
import {
    ActionTypes, AnimationCard, Attachment, AudioCard, CardAction, CardImage, HeroCard,
    MediaUrl, OAuthCard, ReceiptCard, SigninCard, ThumbnailCard, VideoCard
...
export class CardFactory {
     ...
     */
    public static animationCard(title: string,
     ...
     * @param other (Optional) additional properties to include on the card.
     */
    public static audioCard(title: string,
                     media: (MediaUrl|string)[],
                     buttons?: (CardAction|string)[],
     ...
     * @param other (Optional) additional properties to include on the card.
     */
    public static heroCard(title: string, images?: (CardImage|string)[], buttons?: (CardAction|string)[], other?: Partial<HeroCard>): Attachment;
    public static heroCard(title: string, text: string, images?: (CardImage|string)[], buttons?: (CardAction|string)[], other?: Partial<HeroCard>): Attachment;
    public static heroCard(title: string, text?: any, images?: any, buttons?: any, other?: Partial<HeroCard>): Attachment {
     ...
     * @param other (Optional) additional properties to include on the card.
     */
    public static thumbnailCard(title: string, images?: (CardImage|string)[], buttons?: (CardAction|string)[], other?: Partial<ThumbnailCard>): Attachment;
    public static thumbnailCard(title: string, text: string, images?: (CardImage|string)[], buttons?: (CardAction|string)[], other?: Partial<ThumbnailCard>): Attachment;
    public static thumbnailCard(title: string, text?: any, images?: any, buttons?: any, other?: Partial<ThumbnailCard>): Attachment {
     ...
     * @param other (Optional) additional properties to include on the card.
     */
    public static videoCard(title: string,
                     media: (MediaUrl|string)[],
                     buttons?: (CardAction|string)[],
