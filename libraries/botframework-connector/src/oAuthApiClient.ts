...
export class OAuthApiClient {
   ...
   */
  public async getUserTokenWithHttpOperationResponse(userId: string, connectionName: string, magicCode?: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse> {
    ...
    try {
      ...
      if (statusCode === 404) {
        ...
        const error = new msRest.RestError(operationRes.bodyAsText as string);
        error.statusCode = response.status;
        error.request = msRest.stripRequest(httpRequest);
        error.response = msRest.stripResponse(response);
        const parsedErrorResponse = operationRes.bodyAsJson as { [key: string]: any };
        try {
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  public async signOutUserWithHttpOperationResponse(userId: string, connectionName: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse> {
    const client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  public async getSignInLinkWithHttpOperationResponse(conversation: Models.ConversationReference, connectionName: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse> {
    const client = this.client;
   ...
   * @reject {Error|ServiceError} - The error object.
   */
  public async emulateOAuthCardsWithHttpOperationResponse(emulate: boolean, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse> {
    const client = this.client;
   ...
   * @param {RequestOptionsBase} [options] Optional Parameters.
   */
  public getUserToken(userId: string, connectionName: string, magicCode?: string, options?: msRest.RequestOptionsBase): Promise<Models.TokenResponse> {
   ...
   * @returns {Promise} A promise is returned
   */
  public async getSignInLink(conversation: Models.ConversationReference, connectionName: string, options?: msRest.RequestOptionsBase): Promise<string> {
